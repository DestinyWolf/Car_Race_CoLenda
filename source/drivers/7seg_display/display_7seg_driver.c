...
MODULE_DESCRIPTION("Um módule kernel para realizar a comunicação com os displays de 7 segmentos na FPGA");
...
static int __init display_7seg_init(void){
  ...
  display_7seg.LW_virtual = ioremap(LW_BRIDGE_BASE, LW_BRIDGE_SPAN);

  /*Mapeando os endereços dos 6 displays*/
  display_7seg.hex0_ptr = (int*) (display_7seg.LW_virtual + HEX0_BASE);
  display_7seg.hex1_ptr = (int*) (display_7seg.LW_virtual + HEX1_BASE);
  display_7seg.hex2_ptr = (int*) (display_7seg.LW_virtual + HEX2_BASE);
  display_7seg.hex3_ptr = (int*) (display_7seg.LW_virtual + HEX3_BASE);
  display_7seg.hex4_ptr = (int*) (display_7seg.LW_virtual + HEX4_BASE);
  display_7seg.hex5_ptr = (int*) (display_7seg.LW_virtual + HEX5_BASE);
